...
module Dor
  ...
  class WorkflowService
    attr_accessor :handler, :logger, :resource, :dor_services_url, :valid_statuses, :exceptions_to_catch, :workflow_resource
    ...
    def initialize(url_or_connection, opts = {})
      ...
      @workflow_resource = case url_or_connection
                    when String
    ...
    def archive_workflow(repo, druid, wf_name, version_num = nil)
      raise ArgumentError, 'Please call Dor::WorkflowService.new(workflow_service_url, :dor_services_url => DOR_SERVIES_URL) once before archiving workflow' if dor_services_url.nil?
